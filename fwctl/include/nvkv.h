 ...
 *
 * NVKV key/value encoding: instruction layout, opcode/field bit definitions,
 * encoding helper macros, and the public nvkvDecode() entry point used to
 * pack and unpack the compact NvU64 streams that nova-core GMCAPI RPCs use
 * to carry variable-length key/value payloads.
 */
